...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 574
    sget-object v26, Lcom/android/internal/R$styleable;->NumberPicker:[I
    ...
    const v27, #android:layout@number_picker#t
    ...
    const v26, #android:layout@number_picker#t
    ...
    const-string v27, "minHeight > maxHeight"
    ...
    const-string v27, "minWidth > maxWidth"
    ...
    .line 628
    .local v25, virtualButtonPressedRes:I
    const v26, #android:drawable@numberpicker_selection_divider#t
    ...
    .line 634
    :cond_3
    const v26, #android:drawable@item_background_holo_light#t
    ...
    .line 645
    .end local v22           #selectionRes:I
    .end local v25           #virtualButtonPressedRes:I
    :cond_4
    :goto_2
    invoke-virtual {v6}, Landroid/content/res/TypedArray;->recycle()V

    .line 647
    new-instance v26, Landroid/widget/NumberPicker$PressedStateHelper;
    ...
    new-instance v18, Landroid/widget/NumberPicker$2;
    ...
    .line 687
    const v26, #android:id@increment#t
    ...
    .line 696
    const v26, #android:id@decrement#t
    ...
    .line 704
    :goto_5
    const v26, #android:id@numberpicker_input#t
    ...
    new-instance v27, Landroid/widget/NumberPicker$3;
    ...
    new-instance v29, Landroid/widget/NumberPicker$InputTextFilter;

    invoke-direct/range {v29 .. v30}, Landroid/widget/NumberPicker$InputTextFilter;-><init>(Landroid/widget/NumberPicker;)V

    aput-object v29, v27, v28

    invoke-virtual/range {v26 .. v27}, Landroid/widget/EditText;->setFilters([Landroid/text/InputFilter;)V
    ...
    invoke-virtual/range {v26 .. v27}, Landroid/widget/EditText;->setRawInputType(I)V
    ...
    invoke-virtual/range {v26 .. v26}, Landroid/widget/EditText;->getTextSize()F
    ...
    invoke-virtual/range {v26 .. v26}, Landroid/widget/EditText;->getTypeface()Landroid/graphics/Typeface;
    ...
    invoke-virtual/range {v26 .. v26}, Landroid/widget/EditText;->getTextColors()Landroid/content/res/ColorStateList;

    move-result-object v8

    .line 737
    .local v8, colors:Landroid/content/res/ColorStateList;
    sget-object v26, Landroid/widget/NumberPicker;->ENABLED_STATE_SET:[I
    ...
    .line 742
    new-instance v26, Landroid/widget/Scroller;
    ...
    invoke-direct/range {v26 .. v29}, Landroid/widget/Scroller;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;Z)V
    ...
    const/high16 v29, 0x4020

    invoke-direct/range {v28 .. v29}, Landroid/view/animation/DecelerateInterpolator;-><init>(F)V

    invoke-direct/range {v26 .. v28}, Landroid/widget/Scroller;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;)V
    ...
    const v27, #android:attr@background#t
    ...
    invoke-static/range {v26 .. v27}, Lcom/lenovo/ideaui/IdeaUI;->getResFromAttribute(Landroid/content/Context;I)I

    move-result v14

    .line 764
    .local v14, ideaui_res:I
    move-object/from16 v0, p0

    invoke-virtual {v0, v14}, Landroid/widget/NumberPicker;->setBackgroundResource(I)V

    .line 767
    .end local v14           #ideaui_res:I
    :cond_6
    ...
    invoke-static/range {v26 .. v27}, Lcom/lenovo/ideaui/IdeaUI;->getFloatFromAttribute(Landroid/content/Context;I)F
    ...
    invoke-static/range {v26 .. v27}, Lcom/lenovo/ideaui/IdeaUI;->getDataFromAttribute(Landroid/content/Context;I)I
    ...
    invoke-virtual {v0, v1, v12, v13, v2}, Landroid/graphics/Paint;->setShadowLayer(FFFI)V
    ...
    .end local v21           #res:I
    .end local v23           #shadow:I
    .end local v24           #styles:[I
    :cond_7
    return-void
    ...
    .line 637
    .restart local v22       #selectionRes:I
    .restart local v25       #virtualButtonPressedRes:I
    :cond_9
    const v26, #android:drawable@item_background_holo_dark#t
    ...
    .restart local v18       #onLongClickListener:Landroid/view/View$OnLongClickListener;
    :cond_b
    const/16 v26, 0x0
