...
# instance fields
.field BOTTOM_MODEN:I

.field CONTENT_MODEN:I

.field DEFAULT_MODEN:I
...
.field mAllItemsId:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field mCurrenItemsId:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field mCurrentAllItemsId:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field mCurrentRemoveItemsIndex:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field mDelAnimTime:I

.field mDelItemsCount:I
...
.field mNeedDrawChange:Z

.field mNotAnim:Z

.field mOldChildCount:I
...
.field mRemoveItemsId:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field mTranAnimTime:I

.field mTransMoveItemsCoords:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field mTransMoveItemsId:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field mTransMoveItemsIndex:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field mTransMoveitemsOldCoord:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v1, p0, Landroid/widget/AbsListView;->mIdeaUI_ListRoundedRectRadius:F

    .line 911
    iput-boolean v2, p0, Landroid/widget/AbsListView;->mIdeaUI_IsTopRoundedCorner:Z

    .line 912
    iput-boolean v2, p0, Landroid/widget/AbsListView;->mIdeaUI_IsBottomRoundedCorner:Z

    .line 6473
    iput v2, p0, Landroid/widget/AbsListView;->mDelItemsCount:I

    .line 6474
    iput-boolean v2, p0, Landroid/widget/AbsListView;->mNeedDrawChange:Z

    .line 6476
    iput v2, p0, Landroid/widget/AbsListView;->mLastitemBottom:I

    .line 6477
    iput v2, p0, Landroid/widget/AbsListView;->DEFAULT_MODEN:I

    .line 6478
    iput v4, p0, Landroid/widget/AbsListView;->CONTENT_MODEN:I

    .line 6479
    const/4 v1, 0x2

    iput v1, p0, Landroid/widget/AbsListView;->BOTTOM_MODEN:I

    .line 6480
    iget v1, p0, Landroid/widget/AbsListView;->DEFAULT_MODEN:I

    iput v1, p0, Landroid/widget/AbsListView;->mModen:I

    .line 6481
    iput-boolean v2, p0, Landroid/widget/AbsListView;->mIsDrawAnim:Z

    .line 6482
    iput v6, p0, Landroid/widget/AbsListView;->mDelAnimTime:I

    .line 6483
    iput v6, p0, Landroid/widget/AbsListView;->mTranAnimTime:I

    .line 6484
    iput-boolean v4, p0, Landroid/widget/AbsListView;->mNotAnim:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput v14, v0, Landroid/widget/AbsListView;->mIdeaUI_ListRoundedRectRadius:F
    ...
    iput-boolean v14, v0, Landroid/widget/AbsListView;->mIdeaUI_IsTopRoundedCorner:Z
    ...
    iput-boolean v14, v0, Landroid/widget/AbsListView;->mIdeaUI_IsBottomRoundedCorner:Z
    ...
    iput v14, v0, Landroid/widget/AbsListView;->mDelItemsCount:I
    ...
    iput-boolean v14, v0, Landroid/widget/AbsListView;->mNeedDrawChange:Z
    ...
    iput v14, v0, Landroid/widget/AbsListView;->mLastitemBottom:I
    ...
    iput v14, v0, Landroid/widget/AbsListView;->DEFAULT_MODEN:I
    ...
    iput v14, v0, Landroid/widget/AbsListView;->CONTENT_MODEN:I
    ...
    iput v14, v0, Landroid/widget/AbsListView;->BOTTOM_MODEN:I

    .line 6480
    move-object/from16 v0, p0

    iget v14, v0, Landroid/widget/AbsListView;->DEFAULT_MODEN:I

    move-object/from16 v0, p0

    iput v14, v0, Landroid/widget/AbsListView;->mModen:I
    ...
    iput-boolean v14, v0, Landroid/widget/AbsListView;->mIsDrawAnim:Z
    ...
    iput v14, v0, Landroid/widget/AbsListView;->mDelAnimTime:I
    ...
    iput v14, v0, Landroid/widget/AbsListView;->mTranAnimTime:I
    ...
    iput-boolean v14, v0, Landroid/widget/AbsListView;->mNotAnim:Z
    ...
    .line 840
    const v14, #android:drawable@list_selector_holo_light#t
    ...
    .line 877
    const v14, #android:color@background_holo_light#t

    if-eq v8, v14, :cond_2

    const v14, #android:color@background_holo_dark#t

    if-eq v8, v14, :cond_2

    const v14, #android:color@background_dark#t

    if-eq v8, v14, :cond_2

    const v14, #android:color@background_light#t
    ...
    :cond_3
    invoke-direct/range {p0 .. p2}, Landroid/widget/AbsListView;->IdeaUI_InitList(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    :cond_4
    const v14, #android:drawable@list_selector_holo_dark#t
...
.method private IdeaUI_InitList(Landroid/content/Context;Landroid/util/AttributeSet;)V
    .locals 2
    .parameter "context"
    .parameter "attrs"
    ...
    iput-object v1, p0, Landroid/widget/AbsListView;->mIdeaUI_ListRoundedClipPath:Landroid/graphics/Path;
...
.method private createTextFilter(Z)V
    ...
    const v3, #android:layout@typing_filter#t
    ...
    const v4, #android:style@Animation.TypingFilter#t
    ...
    const v4, #android:style@Animation.TypingFilterRestore#t
...
.method public IdeaUI_SetRounderCorner(ZZ)V
    ...
    .prologue
    .line 926
    iput-boolean p1, p0, Landroid/widget/AbsListView;->mIdeaUI_IsTopRoundedCorner:Z

    .line 927
    iput-boolean p2, p0, Landroid/widget/AbsListView;->mIdeaUI_IsBottomRoundedCorner:Z

    .line 929
    iget-boolean v0, p0, Landroid/widget/AbsListView;->mIdeaUI_IsTopRoundedCorner:Z

    if-nez v0, :cond_0

    iget-boolean v0, p0, Landroid/widget/AbsListView;->mIdeaUI_IsBottomRoundedCorner:Z
    ...
    invoke-virtual {p0, v0, v1}, Landroid/widget/AbsListView;->setLayerType(ILandroid/graphics/Paint;)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 4044
    iget-object v8, p0, Landroid/widget/AbsListView;->mIdeaUI_ListRoundedClipPath:Landroid/graphics/Path;

    if-eqz v8, :cond_6

    iget-boolean v8, p0, Landroid/widget/AbsListView;->mIdeaUI_IsTopRoundedCorner:Z

    if-nez v8, :cond_0

    iget-boolean v8, p0, Landroid/widget/AbsListView;->mIdeaUI_IsBottomRoundedCorner:Z
...
.method protected onDetachedFromWindow()V
    ...
    .line 2859
    iget-object v1, p0, Landroid/widget/AbsListView;->mCurrenItemsId:Ljava/util/ArrayList;
    ...
    .line 2860
    :cond_9
    iget-object v1, p0, Landroid/widget/AbsListView;->mCurrentRemoveItemsIndex:Ljava/util/ArrayList;
    ...
    .line 2861
    :cond_a
    iget-object v1, p0, Landroid/widget/AbsListView;->mTransMoveItemsIndex:Ljava/util/ArrayList;
    ...
    .line 2862
    :cond_b
    iget-object v1, p0, Landroid/widget/AbsListView;->mTransMoveItemsCoords:Ljava/util/ArrayList;
    ...
    .line 2863
    :cond_c
    iget-object v1, p0, Landroid/widget/AbsListView;->mTransMoveItemsId:Ljava/util/ArrayList;
    ...
    .line 2864
    :cond_d
    iget-object v1, p0, Landroid/widget/AbsListView;->mTransMoveitemsOldCoord:Ljava/util/ArrayList;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {v3, v5, v6}, Landroid/widget/FastScroller;->onItemCountChanged(II)V
    ...
    .line 2173
    iget-object v3, p0, Landroid/widget/AbsListView;->mIdeaUI_ListRoundedClipPath:Landroid/graphics/Path;

    if-eqz v3, :cond_4

    iget-boolean v3, p0, Landroid/widget/AbsListView;->mIdeaUI_IsTopRoundedCorner:Z

    if-nez v3, :cond_3

    iget-boolean v3, p0, Landroid/widget/AbsListView;->mIdeaUI_IsBottomRoundedCorner:Z
    ...
    iget v4, p0, Landroid/widget/AbsListView;->mIdeaUI_ListRoundedRectRadius:F

    iget v5, p0, Landroid/widget/AbsListView;->mIdeaUI_ListRoundedRectRadius:F
    ...
    .line 2179
    :cond_5
    iget v3, p0, Landroid/widget/AbsListView;->mIdeaUI_ListRoundedRectRadius:F
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    iput-boolean v5, p0, Landroid/widget/AbsListView;->mAdapterHasStableIds:Z
    ...
    iget-boolean v5, p0, Landroid/widget/AbsListView;->mAdapterHasStableIds:Z

    if-eqz v5, :cond_0

    iget-object v5, p0, Landroid/widget/AbsListView;->mCheckedIdStates:Landroid/util/LongSparseArray;
    ...
    iput-object v5, p0, Landroid/widget/AbsListView;->mCheckedIdStates:Landroid/util/LongSparseArray;

    .line 989
    :cond_0
    iget-object v5, p0, Landroid/widget/AbsListView;->mCheckStates:Landroid/util/SparseBooleanArray;
    ...
    .line 1005
    .local v0, bottom:I
    invoke-virtual {p0}, Landroid/widget/AbsListView;->getPaddingLeft()I

    move-result v1

    .line 1006
    .local v1, left:I
    invoke-virtual {p0}, Landroid/widget/AbsListView;->getPaddingRight()I
    ...
    .line 1015
    :goto_0
    invoke-virtual {p0, v1, v4, v3, v0}, Landroid/widget/AbsListView;->setPadding(IIII)V
...
.method public setRemoveArrays(Ljava/util/ArrayList;)V
    .locals 1
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    iput-boolean v0, p0, Landroid/widget/AbsListView;->mNotAnim:Z
