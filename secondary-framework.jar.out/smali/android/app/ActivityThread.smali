...
.method private performLaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/Intent;)Landroid/app/Activity;
    ...
    const-string v4, "/system/fonts/FangZhengLTH.ttf"
...
.method final handleConfigurationChanged(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
    ...
    .line 4149
    iget-object v9, p1, Landroid/content/res/Configuration;->fontPath:Ljava/lang/String;

    if-eqz v9, :cond_6

    iget-object v9, p0, Landroid/app/ActivityThread;->mConfiguration:Landroid/content/res/Configuration;

    iget-object v9, v9, Landroid/content/res/Configuration;->fontPath:Ljava/lang/String;
    ...
    iget-object v11, v11, Landroid/content/res/Configuration;->fontPath:Ljava/lang/String;
    ...
    invoke-virtual {v9}, Landroid/view/WindowManagerGlobal;->trimLocalMemory()V
    ...
    invoke-virtual {v5, v9, v6}, Landroid/app/FontThemeManager;->updateFont(Landroid/content/Context;Ljava/lang/String;)V
    :try_end_2
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_0
...
invoke-virtual {v1, v7}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;
    ...
    invoke-static {v9}, Landroid/app/ActivityThread$BaiduInjector;->multiTheme_refreshFontCache(Landroid/content/ComponentCallbacks2;)V
    ...
    invoke-static {v9}, Landroid/app/FontThemeManager;->changeTextFont(Landroid/content/Context;)V
