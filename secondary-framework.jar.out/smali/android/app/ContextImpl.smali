...
.method public isCts()Z
    ...
    invoke-virtual {v4}, Landroid/content/res/Resources;->isContextPackageNameNull()Z
    ...
    invoke-virtual {v4, v5}, Landroid/content/res/Resources;->setContextPackageName(Ljava/lang/String;)V

    .line 1899
    :cond_0
    #nvoke-static {p0}, Landroid/content/res/Resources;->createLaunchIconThemeIfNeeded(Landroid/content/Context;)V

    sget-boolean v4, Landroid/app/ContextImpl;->mbJudged:Z

    if-nez v4, :cond_1

    sput-boolean v6, Landroid/app/ContextImpl;->mbJudged:Z
    ...
    sput-boolean v6, Landroid/app/ContextImpl;->mIsCts:Z
