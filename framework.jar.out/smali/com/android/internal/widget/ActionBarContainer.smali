...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 68
    .local v3, isLight:Z
    const v8, #android:drawable@ab_transparent_dark_holo#t
    ...
    const v8, #android:drawable@ab_stacked_transparent_dark_holo#t
    ...
    const v9, #android:id@split_action_bar#t
    ...
    .line 146
    .restart local v3       #isLight:Z
    const v8, #android:drawable@ab_bottom_transparent_dark_holo#t
    ...
    .restart local v4       #newBg_id:I
    :cond_a
    const v8, #android:drawable@ab_solid_dark_holo#t
    ...
    .line 74
    :cond_b
    const v8, #android:drawable@ab_transparent_light_holo#t
    ...
    .line 77
    :cond_c
    const v8, #android:drawable@ab_solid_light_holo#t
    ...
    .end local v5           #themeBgId:I
    :cond_e
    const v8, #android:drawable@ab_stacked_solid_dark_holo#t
    ...
    .line 112
    :cond_f
    const v8, #android:drawable@ab_stacked_transparent_light_holo#t
    ...
    .line 115
    :cond_10
    const v8, #android:drawable@ab_stacked_solid_light_holo#t
    ...
    .end local v5           #themeBgId:I
    :cond_12
    const v8, #android:drawable@ab_bottom_solid_dark_holo#t

    if-ne v1, v8, :cond_13

    .line 150
    const/high16 v4, 0x308
    ...
    .line 152
    :cond_13
    const v8, #android:drawable@ab_bottom_transparent_light_holo#t
    ...
    .line 155
    :cond_14
    const v8, #android:drawable@ab_bottom_solid_light_holo#t
    ...
    .line 158
    :cond_15
    const v8, #android:drawable@ab_bottom_solid_inverse_holo#t
