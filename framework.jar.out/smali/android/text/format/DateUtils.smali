...
.method static constructor <clinit>()V
    ...
    :array_0
    .array-data 0x4
        #android:string@same_year_md1_md2#a
        #android:string@same_year_wday1_md1_wday2_md2#a
        #android:string@same_year_mdy1_mdy2#a
        #android:string@same_year_wday1_mdy1_wday2_mdy2#a
        #android:string@same_year_md1_time1_md2_time2#a
        #android:string@same_year_wday1_md1_time1_wday2_md2_time2#a
        #android:string@same_year_mdy1_time1_mdy2_time2#a
        #android:string@same_year_wday1_mdy1_time1_wday2_mdy2_time2#a
        #android:string@numeric_md1_md2#a
        #android:string@numeric_wday1_md1_wday2_md2#a
        #android:string@numeric_mdy1_mdy2#a
        #android:string@numeric_wday1_mdy1_wday2_mdy2#a
        #android:string@numeric_md1_time1_md2_time2#a
        #android:string@numeric_wday1_md1_time1_wday2_md2_time2#a
        #android:string@numeric_mdy1_time1_mdy2_time2#a
        #android:string@numeric_wday1_mdy1_time1_wday2_mdy2_time2#a
    .end array-data

    .line 154
    :array_1
    .array-data 0x4
        #android:string@same_month_md1_md2#a
        #android:string@same_month_wday1_md1_wday2_md2#a
        #android:string@same_month_mdy1_mdy2#a
        #android:string@same_month_wday1_mdy1_wday2_mdy2#a
        #android:string@same_month_md1_time1_md2_time2#a
        #android:string@same_month_wday1_md1_time1_wday2_md2_time2#a
        #android:string@same_month_mdy1_time1_mdy2_time2#a
        #android:string@same_month_wday1_mdy1_time1_wday2_mdy2_time2#a
        #android:string@numeric_md1_md2#a
        #android:string@numeric_wday1_md1_wday2_md2#a
        #android:string@numeric_mdy1_mdy2#a
        #android:string@numeric_wday1_mdy1_wday2_mdy2#a
...
.method public static formatDateRange(Landroid/content/Context;Ljava/util/Formatter;JJILjava/lang/String;)Ljava/util/Formatter;
    ...
    .line 1225
    const v64, #android:string@hour_minute_24#t
    ...
    .line 1322
    const v64, #android:string@numeric_date#t
    ...
    .line 1355
    const v64, #android:string@wday1_date1_time1_wday2_date2_time2#t
    ...
    .line 1239
    const v64, #android:string@hour_cap_ampm#t
    ...
    .line 1272
    const v64, #android:string@Noon#t
    ...
    :cond_24
    const v64, #android:string@hour_ampm#t
    ...
    .line 1245
    const v64, #android:string@hour_minute_cap_ampm#t
    ...
    .line 1247
    :cond_26
    const v64, #android:string@hour_minute_ampm#t
    ...
    .line 1278
    const v64, #android:string@Midnight#t
    ...
    .line 1326
    const v64, #android:string@abbrev_month_year#t
    ...
    .end local v13           #defaultDateFormat:Ljava/lang/String;
    :cond_34
    const v64, #android:string@abbrev_month_day_year#t
    ...
    .line 1332
    const v64, #android:string@month_year#t
    ...
    .end local v13           #defaultDateFormat:Ljava/lang/String;
    :cond_36
    const v64, #android:string@month_day_year#t
    ...
    .line 1340
    const v64, #android:string@abbrev_month#t
    ...
    .end local v13           #defaultDateFormat:Ljava/lang/String;
    :cond_38
    const v64, #android:string@abbrev_month_day#t
    ...
    .line 1346
    const v64, #android:string@month#t
    ...
    .end local v13           #defaultDateFormat:Ljava/lang/String;
    :cond_3a
    const v64, #android:string@month_day#t
    ...
    .line 1357
    :cond_3b
    const v64, #android:string@wday1_date1_wday2_date2#t
    ...
    .line 1361
    const v64, #android:string@date1_time1_date2_time2#t
    ...
    .end local v30           #fullFormat:Ljava/lang/String;
    :cond_3d
    const v64, #android:string@date1_date2#t
    ...
    .line 1391
    const v64, #android:string@short_format_month#t
    ...
    .line 1487
    const v64, #android:string@time_wday_date#t
    ...
    :cond_55
    const v64, #android:string@time1_time2#t
    ...
    :cond_56
    const v64, #android:string@wday_date#t
    ...
    .line 1495
    const v64, #android:string@time_date#t
    ...
    .line 1504
    const v64, #android:string@time_wday#t
...
.method public static getRelativeDateTimeString(Landroid/content/Context;JJJI)Ljava/lang/CharSequence;
    ...
    const v3, #android:string@relative_time#t
    ...
    const v3, #android:string@date_time#t
...
.method public static getRelativeTimeSpanString(JJJI)Ljava/lang/CharSequence;
    ...
    .line 395
    const v14, #android:plurals@abbrev_num_seconds_ago#t
    ...
    .line 401
    const v14, #android:plurals@abbrev_in_num_seconds#t
    ...
    .end local v14           #resId:I
    :cond_4
    const v14, #android:plurals@in_num_seconds#t
    ...
    .line 410
    const v14, #android:plurals@abbrev_num_minutes_ago#t
    ...
    .end local v14           #resId:I
    :cond_6
    const v14, #android:plurals@num_minutes_ago#t
    ...
    .line 416
    const v14, #android:plurals@abbrev_in_num_minutes#t
    ...
    .end local v14           #resId:I
    :cond_8
    const v14, #android:plurals@in_num_minutes#t
    ...
    .line 425
    const v14, #android:plurals@abbrev_num_hours_ago#t
    ...
    .end local v14           #resId:I
    :cond_a
    const v14, #android:plurals@num_hours_ago#t
    ...
    .line 431
    const v14, #android:plurals@abbrev_in_num_hours#t
    ...
    .end local v14           #resId:I
    :cond_c
    const v14, #android:plurals@in_num_hours#t
    ...
    .line 440
    const v14, #android:plurals@abbrev_num_days_ago#t
    ...
    .end local v14           #resId:I
    :cond_e
    const v14, #android:plurals@num_days_ago#t
    ...
    .line 446
    const v14, #android:plurals@abbrev_in_num_days#t
    ...
    .end local v14           #resId:I
    :cond_10
    const v14, #android:plurals@in_num_days#t
...
.method public static getRelativeTimeSpanString(Landroid/content/Context;JZ)Ljava/lang/CharSequence;
    ...
    const v10, #android:string@preposition_for_time#t
    ...
    const v10, #android:string@preposition_for_date#t
