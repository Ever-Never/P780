...
.field private mWaitForCofirmation:Z
...
.method static constructor <clinit>()V
    ...
    const-string v1, "com.lenovo.factorymode"
    ...
    sput-object v0, Landroid/server/BluetoothService;->whiteListPackages:[Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 623
    iput v4, p0, Landroid/server/BluetoothService;->mConfirmResult:I

    .line 627
    iput-boolean v4, p0, Landroid/server/BluetoothService;->mWaitForCofirmation:Z
...
.method static synthetic access$1100(Landroid/server/BluetoothService;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1200(Landroid/server/BluetoothService;)Landroid/os/Handler;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1300(Landroid/server/BluetoothService;)Z
    ...
    .prologue
    .line 115
    iget-boolean v0, p0, Landroid/server/BluetoothService;->mWaitForCofirmation:Z

    return v0
.end method

.method static synthetic access$1402(Landroid/server/BluetoothService;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 115
    iput p1, p0, Landroid/server/BluetoothService;->mConfirmResult:I
...
.method static synthetic access$1500(Landroid/server/BluetoothService;)Landroid/os/Handler;
    ...
    .prologue
    .line 115
    iget-object v0, p0, Landroid/server/BluetoothService;->mConfirmHandler:Landroid/os/Handler;
...
.method static synthetic access$300(Landroid/server/BluetoothService;)Landroid/server/BluetoothBondState;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$400(Landroid/server/BluetoothService;II)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method private declared-synchronized updateSdpRecords()V
    ...
    const v3, #android:bool@config_bluetooth_default_profiles#t
...
.method public declared-synchronized disable(Z)Z
    ...
    const-string v4, "disable(). CallingPid: "
...
.method public declared-synchronized enable(ZZ)Z
    ...
    const-string v18, "android.permission.BLUETOOTH_ADMIN"

    const-string v19, "Need BLUETOOTH_ADMIN permission"
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/server/BluetoothService;->isAirplaneModeOn()Z
    ...
    const-string v19, "enable(). CallingPid: "
    ...
    .line 743
    .local v3, appInfo:Landroid/app/ActivityManager$RunningAppProcessInfo;
    if-eqz v3, :cond_7
    ...
    .line 747
    sget-object v5, Landroid/server/BluetoothService;->whiteListPackages:[Ljava/lang/String;
    ...
    .line 749
    .local v16, whiteListPackage:Ljava/lang/String;
    ...
    .line 756
    .end local v16           #whiteListPackage:Ljava/lang/String;
    :cond_1
    const/16 v17, 0x1
    ...
    .line 783
    .end local v3           #appInfo:Landroid/app/ActivityManager$RunningAppProcessInfo;
    ...
    const-string v17, "android.bluetooth.adapter.action.CONFIRM_ENABLE_BLUETOOTH"
    ...
    .line 788
    const-string v17, "android.bluetooth.adapter.extra.APPLICATION_LABEL"
    ...
    iput v0, v1, Landroid/server/BluetoothService;->mConfirmResult:I
    ...
    .line 802
    :cond_5
    new-instance v17, Landroid/server/BluetoothService$1;

    move-object/from16 v0, v17

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Landroid/server/BluetoothService$1;-><init>(Landroid/server/BluetoothService;)V

    move-object/from16 v0, v17

    move-object/from16 v1, p0

    iput-object v0, v1, Landroid/server/BluetoothService;->mConfirmHandler:Landroid/os/Handler;
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
    ...
    const-string v18, "enable(), enter loop."
    ...
    iput-boolean v0, v1, Landroid/server/BluetoothService;->mWaitForCofirmation:Z
    ...
    const-string v19, "enable(), exit loop. ConfirmResult: "
    ...
    iget v0, v0, Landroid/server/BluetoothService;->mConfirmResult:I
    ...
    const-string v18, "enable(), User Reject"
    ...
    .restart local v3       #appInfo:Landroid/app/ActivityManager$RunningAppProcessInfo;
    ...
    .restart local v16       #whiteListPackage:Ljava/lang/String;
    :cond_6
    ...
    const-string v19, "enable(), Exception: "
    ...
    .restart local v3       #appInfo:Landroid/app/ActivityManager$RunningAppProcessInfo;
    .restart local v4       #appList:Ljava/util/List;,"Ljava/util/List<Landroid/app/ActivityManager$RunningAppProcessInfo;>;"
    .restart local v6       #bNeedNotify:Z
    .restart local v8       #i:I
    ...
    iput-boolean v0, v1, Landroid/server/BluetoothService;->mAllowConnect:Z

    .line 846
    move-object/from16 v0, p0

    iget-object v0, v0, Landroid/server/BluetoothService;->mBluetoothState:Landroid/server/BluetoothAdapterStateMachine;
    ...
    invoke-virtual/range {v17 .. v19}, Landroid/server/BluetoothAdapterStateMachine;->sendMessage(ILjava/lang/Object;)V
    :try_end_6
    .catchall {:try_start_6 .. :try_end_6} :catchall_0
...
.method public declared-synchronized initAfterRegistration()V
    ...
    const v1, #android:bool@config_bluetooth_adapter_quick_switch#t
