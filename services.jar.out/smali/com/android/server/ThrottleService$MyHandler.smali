...
.method private checkThrottleAndPostNotification(J)V
    ...
    const v22, #android:drawable@stat_sys_throttled#t

    invoke-virtual/range {v21 .. v22}, Landroid/app/NotificationManager;->cancel(I)V

    .line 617
    const v21, #android:string@throttled_notification_title#t

    const v22, #android:string@throttled_notification_message#t

    const v23, #android:drawable@stat_sys_throttled#t
    ...
    .line 652
    const v21, #android:string@throttle_warning_notification_title#t

    const v22, #android:string@throttle_warning_notification_message#t
...
.method private clearThrottleAndNotification()V
    ...
    const v4, #android:drawable@stat_sys_throttled#t
...
.method private onPolicyChanged()V
    ...
    const v14, #android:integer@config_datause_polling_period_sec#t
    ...
    const v14, #android:integer@config_datause_threshold_bytes#t
    ...
    const v14, #android:integer@config_datause_throttle_kbitsps#t
    ...
    const v14, #android:integer@config_datause_notification_type#t
