...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/power/DisplayPowerController$CoverOffReceiver;
    }
.end annotation


# static fields
.field private static final BRIGHTENING_LIGHT_DEBOUNCE:J = 0x1f4L
...
.field private static final ELECTRON_BEAM_QUICK_OFF_ANIMATION_DURATION_MILLIS:I = 0x14

.field private static final LCD_IEMODE_DEBOUNCE:J = 0xfa0L
...
.field private static final MSG_LIGHT_SENSOR_IEMODE_DEBOUNCED:I = 0x4
...
# instance fields
.field private final INTENSE_LIGHT:I
...
.field private mDebounceLcdIEModTime:J

.field private mDebounceLuxDirection:I

.field private mDebounceLuxTime:J

.field private mDiscardFirstValue:Z
...
.field private mInRoomBackLight:I
...
.method public constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/android/server/power/Notifier;Lcom/android/server/LightsService;Lcom/android/server/TwilightService;Landroid/hardware/SensorManager;Lcom/android/server/display/DisplayManagerService;Lcom/android/server/power/DisplayBlanker;Lcom/android/server/power/DisplayPowerController$Callbacks;Landroid/os/Handler;)V
    ...
    iput-boolean v6, p0, Lcom/android/server/power/DisplayPowerController;->mDiscardFirstValue:Z
    ...
    iput v6, p0, Lcom/android/server/power/DisplayPowerController;->INTENSE_LIGHT:I
    ...
    iput v6, p0, Lcom/android/server/power/DisplayPowerController;->mInRoomBackLight:I
    ...
    iput-boolean v6, p0, Lcom/android/server/power/DisplayPowerController;->mStepChanged:Z
    ...
    const-string v6, "android.intent.action.COVER_EVENT"
    ...
    new-instance v7, Lcom/android/server/power/DisplayPowerController$CoverOffReceiver;

    const/4 v8, 0x0

    invoke-direct {v7, p0, v8}, Lcom/android/server/power/DisplayPowerController$CoverOffReceiver;-><init>(Lcom/android/server/power/DisplayPowerController;Lcom/android/server/power/DisplayPowerController$1;)V
...
.method static synthetic access$1100(Lcom/android/server/power/DisplayPowerController;)V
    ...
    .prologue
    .line 96
    invoke-direct {p0}, Lcom/android/server/power/DisplayPowerController;->debounceIeMode()V
...
.method static synthetic access$1902(Lcom/android/server/power/DisplayPowerController;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2000(Lcom/android/server/power/DisplayPowerController;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2102(Lcom/android/server/power/DisplayPowerController;Landroid/util/Spline;)Landroid/util/Spline;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2200(Lcom/android/server/power/DisplayPowerController;)[I
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2300(Lcom/android/server/power/DisplayPowerController;)[I
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2400([I[I)Landroid/util/Spline;
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$300(Lcom/android/server/power/DisplayPowerController;)Ljava/lang/Object;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$402(Lcom/android/server/power/DisplayPowerController;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 96
    iput-boolean p1, p0, Lcom/android/server/power/DisplayPowerController;->mDiscardFirstValue:Z
...
.method static synthetic access$600(Lcom/android/server/power/DisplayPowerController;)Lcom/android/server/power/DisplayPowerController$Callbacks;
    .locals 1
    .parameter "x0"
...
.method private applyLightSensorMeasurement(JF)V
    ...
    .line 1146
    iget-boolean v2, p0, Lcom/android/server/power/DisplayPowerController;->mDiscardFirstValue:Z
    ...
    iput-boolean v2, p0, Lcom/android/server/power/DisplayPowerController;->mDiscardFirstValue:Z

    .line 1156
    iput-boolean v5, p0, Lcom/android/server/power/DisplayPowerController;->isAdjLcdBrightnessFirstCall:Z
    ...
    const-string v3, "lincl1+++wake up by psensor or uncover use lux value 350 instead"
...
.method private debounceIeMode()V
    .locals 7
    ...
    const-string v4, "debounceLightSensor for ie mode: Synthesizing light sensor measurement after "
    ...
    invoke-static {}, Lcom/mediatek/pq/PictureQuality;->getModeIE()I
    ...
    invoke-static {v2}, Lcom/mediatek/pq/PictureQuality;->setModeIE(I)Ljava/lang/String;
...
.method private getAutoBrightLevelPos(F)I
    .locals 2
    .parameter "v"
...
.method private setIEMode(I)V
    ...
    .line 1360
    iget v0, p0, Lcom/android/server/power/DisplayPowerController;->mRecentShortTermAverageLux:F
    ...
    invoke-static {v1}, Lcom/mediatek/pq/PictureQuality;->setModeIE(I)Ljava/lang/String;
...
.method private setSmartBrightnessMode(I)V
    ...
    .line 1778
    iget-object v2, p0, Lcom/android/server/power/DisplayPowerController;->mJsonData:Ljava/lang/String;

    if-eqz v2, :cond_1

    iget-boolean v2, p0, Lcom/android/server/power/DisplayPowerController;->mIsSmartBrightnessDebug:Z
    ...
    const-string v4, "lincl1++<<<<< setSmartBrightnessMode >>>>> mode="
    ...
    .line 1780
    const-string v2, "lcd1"

    invoke-direct {p0, v2}, Lcom/android/server/power/DisplayPowerController;->getConfigArray(Ljava/lang/String;)[I

    move-result-object v2

    iput-object v2, p0, Lcom/android/server/power/DisplayPowerController;->mLcdBacklightValues:[I
    ...
    invoke-direct {p0, v2}, Lcom/android/server/power/DisplayPowerController;->getAutoBrightLevelPos(F)I
    ...
    iput v2, p0, Lcom/android/server/power/DisplayPowerController;->mInRoomBackLight:I
    ...
    const-string v3, "lincl1+++smart backlight  mJsonData is null"

    invoke-static {v2, v3}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1786
    const v2, #android:array@config_autoBrightnessLcdBacklightValues1#t
    ...
    .line 1797
    const v2, #android:array@config_autoBrightnessLcdBacklightValues2#t
    ...
    .line 1808
    const v2, #android:array@config_autoBrightnessLcdBacklightValues3#t
...
.method private shouldAdjLcdBrightness(FF)Z
    .locals 8
    .parameter "oldlux"
    .parameter "lux"
    ...
    const-string v3, "lincl1+++ now first call alway run do bright change"
    ...
    const-string v3, "now brightened"
    ...
    .line 1743
    invoke-direct {p0, p2}, Lcom/android/server/power/DisplayPowerController;->getAutoBrightLevelPos(F)I

    move-result v2

    invoke-direct {p0, p1}, Lcom/android/server/power/DisplayPowerController;->getAutoBrightLevelPos(F)I
    ...
    const-string v2, "lincl1+++ brightened too close don\'t adj lcdbrightness"
    ...
    const-string v2, "lincl1+++ now darkest condition alway do bright change"
    ...
    const-string v2, "lincl1+++ darker too close don\'t adj lcdbrightness"
...
.method private updateAmbientLux(J)V
    ...
    iput v6, p0, Lcom/android/server/power/DisplayPowerController;->mAmbientLux:F
    ...
    .line 1182
    iput-wide p1, p0, Lcom/android/server/power/DisplayPowerController;->mDebounceLcdIEModTime:J
    ...
    invoke-direct {p0, v6}, Lcom/android/server/power/DisplayPowerController;->setIEMode(I)V
    ...
    const-string v8, "updateAmbientLux: Possibly brightened, waiting for 500 ms: brighteningLuxThreshold="
    ...
    iget-wide v6, p0, Lcom/android/server/power/DisplayPowerController;->mDebounceLcdIEModTime:J
    ...
    const-string v8, "updateAmbientLux: Brightened: brighteningLuxThreshold="
    ...
    .end local v4           #debounceTime_lcd:J
    :cond_9
    iget v6, p0, Lcom/android/server/power/DisplayPowerController;->mAmbientLux:F
    ...
    const-string v8, "updateAmbientLux: Possibly darkened, waiting for 10000 ms: darkeningLuxThreshold="
    ...
    iget-object v8, p0, Lcom/android/server/power/DisplayPowerController;->mAutoBrightnessLevels:[I
    ...
    .line 1268
    .restart local v4       #debounceTime_lcd:J
    cmp-long v6, p1, v2
    ...
    const-string v8, "updateAmbientLux: Darkened: darkeningLuxThreshold="
    ...
    const-string v8, "updateAmbientLux: Canceled debounce: brighteningLuxThreshold="
    ...
    const-string v8, ", darkeningLuxThreshold="
...
.method private updatePowerState()V
    ...
    .line 793
    iput-boolean v8, p0, Lcom/android/server/power/DisplayPowerController;->mDiscardFirstValue:Z
    ...
    .line 796
    iput-boolean v7, p0, Lcom/android/server/power/DisplayPowerController;->mDiscardFirstValue:Z
...
.method static synthetic access$iget-mScreenSmartBrightnessAdvanceStep-5611dd(Lcom/android/server/power/DisplayPowerController;)I
    .locals 1
    .parameter "x0"

    .prologue
    iget v0, p0, Lcom/android/server/power/DisplayPowerController;->mScreenSmartBrightnessAdvanceStep:I

    return v0
.end method

.method static synthetic access$iput-mScreenSmartBrightnessAdvanceStep-dfafb6(Lcom/android/server/power/DisplayPowerController;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"

    .prologue
    iput p1, p0, Lcom/android/server/power/DisplayPowerController;->mScreenSmartBrightnessAdvanceStep:I

    return p1
.end method

.method static synthetic access$iput-mStepChanged-3769a5(Lcom/android/server/power/DisplayPowerController;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"

    .prologue
    iput-boolean p1, p0, Lcom/android/server/power/DisplayPowerController;->mStepChanged:Z

    return p1
.end method

.method static synthetic access$invoke-updateAutoBrightness-83bc6b(Lcom/android/server/power/DisplayPowerController;Z)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
